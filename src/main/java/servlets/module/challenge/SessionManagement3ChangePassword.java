...
/**
 * Session Management Challenge Three - Change Password This is a level function
 * - DOES NOT RETURN KEY <br/>
 * <br/>
...
public class SessionManagement3ChangePassword extends HttpServlet {
	...
	// private static String levelResult = ""; //This Servlet does not return a
	// result
	/**
	 * Function used by Session Management Challenge Three to change the password of
	 * the submitted user name specified in the "Current" cookie
	 * 
	 * @param current
	 *            User cookie used to store the current user (encoded twice with
	 *            base64)
	 * @param newPassword
	 *            the password which to use to update an accounts password
	 */
