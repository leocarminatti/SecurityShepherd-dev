	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (Validate.validateSession(ses)) {
			...
			try {
				...
				// Output Order
				htmlOutput = "<h3>" + bundle.getString("insecureCyrptoStorage.4.orderComplete") + "</h3>" + "<p>"
						+ bundle.getString("insecureCyrptoStorage.4.orderShipped") + "<br/></p>" + "<p>"
						+ bundle.getString("insecureCyrptoStorage.4.totalCost") + " <a><strong>$" + finalCost
						+ "</strong></a></p>";
				if (trollAmount > 0 && trollCost == 0) {
					htmlOutput += "<p>" + bundle.getString("insecureCyrptoStorage.4.freeTrolls") + " - "
