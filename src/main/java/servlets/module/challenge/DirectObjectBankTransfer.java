...
/**
 * Insecure Direct Object Reference Bank Challenge Transfer Funds Function DOES
 * NOT RETURN RESULT KEY <br/>
 * <br/>
...
public class DirectObjectBankTransfer extends HttpServlet {
	...
	/**
	 * This Servlet is used to transfer funds from one bank account to another,
	 * insecurely, in the Direct Object Reference Bank challenge
	 */
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ResourceBundle bundle = ResourceBundle.getBundle("i18n.servlets.challenges.directObject.directObjectBank",
				locale);
			...
			try {
				...
				if (tranferAmount > 0) {
					...
					if ((senderFunds - tranferAmount) > 0) {
						...
						try {
							float recieverAccountBalanace = DirectObjectBankLogin
									.getAccountBalance(recieverAccountNumber, applicationRoot);
