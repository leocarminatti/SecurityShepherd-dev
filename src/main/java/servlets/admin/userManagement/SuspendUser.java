			...
			if(Validate.validateTokens(tokenCookie, tokenParmeter))
			{
				...
				try
				{
					...
					if(notNull && validPlayer)
					{
						...
						if(Setter.suspendUser(ApplicationRoot, player, amountOfMinutes))
						{
							...
							reponseMessage += "<a>" + Encode.forHtml(userName) + "</a> has been suspended for <b>" + amountOfMinutes + "</b> minutes.";
						}
						else
						{
