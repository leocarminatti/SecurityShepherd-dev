...
public class Setter {
	 ...
	 *            Class name
	 * @param classYear
	 *            Year of the class in YY/YY. eg 11/12
	 * @return
	 */
	 ...
	 * 
	 * @param ApplicationRoot
	 *            Current running director of the application
	 * @param moduleId
	 *            The identifier of the module that is been set to open status
	...
	final public static String webModuleCategoryHardcodedWhereClause = new String("" + "moduleCategory = 'CSRF'"
			+ " OR moduleCategory = 'Failure to Restrict URL Access'" + " OR moduleCategory = 'Injection'"
			+ " OR moduleCategory = 'Insecure Cryptographic Storage'"
			+ " OR moduleCategory = 'Insecure Direct Object References'" + " OR moduleCategory = 'Poor Data Validation'"
			+ " OR moduleCategory = 'Security Misconfigurations'" + " OR moduleCategory = 'Session Management'"
			+ " OR moduleCategory = 'Unvalidated Redirects and Forwards'" + " OR moduleCategory = 'XSS'");
	final public static String mobileModuleCategoryHardcodedWhereClause = new String(""
			+ "moduleCategory = 'Mobile Broken Crypto'" + " OR moduleCategory = 'Mobile Content Provider'"
			+ " OR moduleCategory = 'Mobile Data Leakage'" + " OR moduleCategory = 'Mobile Injection'"
			+ " OR moduleCategory = 'Mobile Insecure Data Storage'"
			+ " OR moduleCategory = 'Mobile Poor Authentication'" + " OR moduleCategory = 'Mobile Reverse Engineering'"
	 ...
	 * 
	 * @param ApplicationRoot
	 *            Used to locate database properties file
	 * @return
	 */
	public static boolean openOnlyMobileCategories(String ApplicationRoot) {
		...
		try {
			PreparedStatement prepstmt = conn.prepareStatement(
					"UPDATE modules SET moduleStatus = 'closed' WHERE " + webModuleCategoryHardcodedWhereClause);
			prepstmt.execute();
			log.debug("Web Levels have been closed");
			prepstmt = conn.prepareStatement(
					"UPDATE modules SET moduleStatus = 'open' WHERE " + mobileModuleCategoryHardcodedWhereClause);
			prepstmt.execute();
	...
	public static boolean openOnlyWebCategories(String ApplicationRoot) {
		...
		try {
			PreparedStatement prepstmt = conn.prepareStatement(
					"UPDATE modules SET moduleStatus = 'open' WHERE " + webModuleCategoryHardcodedWhereClause);
			prepstmt.execute();
			log.debug("Web Levels have been opened");
			prepstmt = conn.prepareStatement(
					"UPDATE modules SET moduleStatus = 'closed' WHERE " + mobileModuleCategoryHardcodedWhereClause);
			prepstmt.execute();
	 ...
	 * 
	 * @param ApplicationRoot
	 *            Application's running context
	 * @param userId
	 *            User Identifier to reset
	 * @return
	 */
	 ...
	 * 
	 * @param applicationRoot
	 *            The directory that the server is actually in
	 * @param url
	 ...
	 *            User Identifier
	 * @param csrfToken
	 *            CSRF Token to add to the csrfChallengeFour DB Schema
	 * @param ApplicationRoot
	 ...
	 *            User Identifier
	 * @param csrfToken
	 *            CSRF Token to add to the csrfChallengeSix DB Schema
	 * @param ApplicationRoot
	 *            Running context of the application
	 * @return
	 */
	 ...
	 *            The module category to open or closed
	 * @param openOrClosed
	 *            What to set the module status to. Can only be "open" or "closed"
	 * @return True if method executes without failure
	 */
	public static boolean setModuleCategoryStatusOpen(String ApplicationRoot, String moduleCategory,
			String openOrClosed) {
		...
		try {
			PreparedStatement prepstmt = conn
					.prepareStatement("UPDATE modules SET moduleStatus = ? WHERE moduleCategory = ?");
	 ...
	 *            Current running director of the application
	 * @param moduleId
	 *            The identifier of the module that is been set to closed status
	 * @return Boolean result depicting success of statement
	 */
	 ...
	 * 
	 * @param ApplicationRoot
	 *            The current running context of the application
	 * @param message
	 *            The String they want to store
	 * @param userId
	 *            The identifier of the user in which to store the attack under
	 * @param moduleId
	 *            The module identifier of which to store the message under
	 ...
	 * 
	 * @param ApplicationRoot
	 *            Running context of application
	 * @param userId
	 *            User Identifier of the to be suspended user
	 * @param numberOfMinutes
	 *            Amount of minutes to suspend user
	 ...
	 *            Running context of application
	 * @param userId
	 *            The Identifier of the user that will be released from suspension
	 * @return
	 */
	 ...
	 *            The current running context of the application.
	 * @param moduleId
	 *            The identifier of the module to increment the counter of
	 * @param userId
	 *            The user to be incremented
	 ...
	 * @param newPassword
	 *            New password to use in update
	 * @return ResultSet that contains error details if not successful
	 */
	public static boolean updatePassword(String ApplicationRoot, String userName, String currentPassword,
			String newPassword) {
	 ...
	 * 
	 * @param ApplicationRoot
	 *            Running context of the applicaiton
	 * @param userId
	 ...
	 *            The current running context of the application
	 * @param classId
	 *            New class to be assigned to
	 * @param playerId
	 *            Player to be assigned to new class
	 ...
	 *            The current running context of the application
	 * @param playerId
	 *            The identifier of the player to be assigned to class NULL
	 * @return The userName that was updated
	 */
	 ...
	 *            The current running context of the application
	 * @param moduleId
	 *            Identifier of the module the user is completing
	 * @param userId
	 *            Identifier of the user completing the module
	 * @param extra
	 *            The additional comments submitted in feedback by the user, or if
	 *            CSRF, the attack string they used
	 * @param before
	 *            The knowledge the user felt before they completed the level
	 * @param after
	 *            The knowledge the user felt after they completed the level
	 * @param difficulty
	 *            The difficulty the user felt they encountered
	 * @return The module name of the module completed by the user
	 */
	public static String updatePlayerResult(String ApplicationRoot, String moduleId, String userId, String extra,
	 ...
	 * @param points
	 *            Positive or Negative number of points to update by
	...
	public static boolean updateUserPoints(String ApplicationRoot, String userId, int points) {
		...
		try {
			...
			CallableStatement callstmnt = conn
					.prepareCall("UPDATE users SET userScore = userScore + ? WHERE userId = ?");
	 ...
	 * @param ApplicationRoot
	 * @param classId
	 *            Cannot be null, relationship depending
	 * @param userName
	 *            Cannot be null
	 * @param userPass
	 *            Cannot be null
	 * @param userRole
	 *            Cannot be null, must be "player" or "admin"
	 * @param userAddress
	 *            Must be unique
	 * @param tempPass
	 *            Whether or not to set the user with a temporary pass flag
	 * @return A boolean value determining the result of the creation
	 * @throws SQLException
	 *             If the creation fails, a Exception is thrown
	 */
	public static boolean userCreate(String ApplicationRoot, String classId, String userName, String userPass,
			String userRole, String userAddress, boolean tempPass) throws SQLException {
		boolean result = false;
